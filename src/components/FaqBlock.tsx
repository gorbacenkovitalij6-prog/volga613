...
const faqs = [
  {
    ...
    answer: "Итоговая стоимость под ключ включает в себя цену автомобиля за границей, расходы на логистику, таможенные платежи, утилизационный сбор и нашу комиссию за подбор и сопровождение. Мы предоставляем полностью прозрачный расчет до подписания договора."
  },
  {
    question: "Могу ли я купить автомобиль в кредит?",
    answer: "Да, мы сотрудничаем с ведущими банками, что позволяет вам приобрести автомобиль с пробегом из Европы или Кореи в кредит на выгодных условиях."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы гарантируем юридическую чистоту автомобиля, полное соответствие заявленному техническому состоянию на этапе подбора, а также прозрачность всех платежей. Гарантии фиксируются в договоре."
  },
  {
